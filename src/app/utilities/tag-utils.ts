import { HydrusFile, ServiceNamesToStatusesToTags } from "../entities/hydrus-file";
...
export class TagUtils {
  ...
  public static namespaceTagFromFile(file: HydrusFile, namespace: string): string | undefined {
