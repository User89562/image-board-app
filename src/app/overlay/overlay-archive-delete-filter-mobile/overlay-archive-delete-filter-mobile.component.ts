...
@Component({
  selector: 'app-overlay-archive-delete-filter-mobile',
  templateUrl: './overlay-archive-delete-filter-mobile.component.html',
...
export class OverlayArchiveDeleteFilterMobileComponent implements OnInit {
